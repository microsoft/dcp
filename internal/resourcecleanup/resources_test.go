...
func TestShutdownResourcesIncludeV1AndV2Namespace(t *testing.T) {
	...
	require.NotContains(t, shutdownResourceGVRs, (&apiv2.PhysicalNetwork{}).GetGroupVersionResource())
}
...
func TestNamespaceResourcesCleanPhysicalContainersFirst(t *testing.T) {
	...
	physicalNetworkGVR := (&apiv2.PhysicalNetwork{}).GetGroupVersionResource()
	...
	require.Contains(t, namespaceResourcesByGVR, physicalNetworkGVR)
	...
	require.Contains(t, namespaceResourcesByGVR[physicalNetworkGVR].CleanUpAfter, physicalContainerGVR)
}
