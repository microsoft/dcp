...
import (
	...
	commonapi "github.com/microsoft/dcp/pkg/commonapi"
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		v2.CreateFileSystem{}.OpenAPIModelName():                       schema_microsoft_dcp_api_v2_CreateFileSystem(ref),
		v2.FileSystemEntry{}.OpenAPIModelName():                        schema_microsoft_dcp_api_v2_FileSystemEntry(ref),
		...
		v2.PhysicalContainerNetworkConnection{}.OpenAPIModelName():     schema_microsoft_dcp_api_v2_PhysicalContainerNetworkConnection(ref),
		v2.PhysicalContainerNetworkConnectionList{}.OpenAPIModelName(): schema_microsoft_dcp_api_v2_PhysicalContainerNetworkConnectionList(ref),
		v2.PhysicalContainerNetworkConnectionSpec{}.OpenAPIModelName(): schema_microsoft_dcp_api_v2_PhysicalContainerNetworkConnectionSpec(ref),
...
func schema_microsoft_dcp_api_v1_Container(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Container resource represents a container run using an orchestrator such as Docker or Podman",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ContainerBuildContext(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.ContainerBuildSecret{}.OpenAPIModelName(), v1.ContainerLabel{}.OpenAPIModelName(), commonapi.EnvVar{}.OpenAPIModelName()},
	}
}
...
func schema_microsoft_dcp_api_v1_ContainerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerList contains a list of Executable instances",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ContainerNetworkTunnelProxy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerNetworkTunnelProxy represents a tunnel proxy pair that handles multiple tunnels between a container network and host network.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ContainerNetworkTunnelProxyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerNetworkTunnelProxyList contains a list of ContainerNetworkTunnelProxy instances",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ContainerNetworkTunnelProxySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerNetworkTunnelProxySpec defines the desired state of a ContainerNetworkTunnelProxy.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"containerNetworkName": {
						SchemaProps: spec.SchemaProps{
							Description: "Reference to the ContainerNetwork that the client proxy should connect to. This field is required and must reference an existing ContainerNetwork resource.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"tunnels": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "List of tunnels to prepare. Each tunnel enables clients on the container network to connect to a server on the host (establish a tunnel stream).",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"baseImage": {
						SchemaProps: spec.SchemaProps{
							Description: "Base container image to use for the client proxy container. Defaults to mcr.microsoft.com/azurelinux/base/core:3.0 if not specified.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"containerNetworkName"},
			},
		},
		Dependencies: []string{
...
func schema_microsoft_dcp_api_v1_ContainerNetworkTunnelProxyStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerNetworkTunnelProxyStatus defines the current state of a ContainerNetworkTunnelProxy.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"state": {
						SchemaProps: spec.SchemaProps{
							Description: "Overall state of the tunnel proxy pair.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tunnelStatuses": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Status of individual tunnels within the proxy pair.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"tunnelConfigurationVersion": {
						SchemaProps: spec.SchemaProps{
							Description: "Monotonically increasing version number of the tunnel configuration that was applied to the proxy pair. Can be used by clients changing tunnel configuration (Tunnels property) to learn that the new configuration has become effective.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					...
					"serverProxyProcessId": {
						SchemaProps: spec.SchemaProps{
							Description: "Server proxy process ID.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					...
					"serverProxyStdOutFile": {
						SchemaProps: spec.SchemaProps{
							Description: "The path of a temporary file that contains captured standard output data from the server proxy process.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"serverProxyStdErrFile": {
						SchemaProps: spec.SchemaProps{
							Description: "The path of a temporary file that contains captured standard error data from the server proxy process.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"clientProxyControlPort": {
						SchemaProps: spec.SchemaProps{
							Description: "Published (host) port for client proxy control endpoint.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"clientProxyDataPort": {
						SchemaProps: spec.SchemaProps{
							Description: "Published (host) port for client proxy data endpoint.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"serverProxyControlPort": {
						SchemaProps: spec.SchemaProps{
							Description: "Server proxy control port (for controlling the proxy pair).",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_microsoft_dcp_api_v1_ContainerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"envFiles": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Environment files to use to populate Container environment during startup.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"runArgs": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Additional arguments to pass to the container run command",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			v1.ContainerBuildContext{}.OpenAPIModelName(), v1.ContainerLabel{}.OpenAPIModelName(), v1.ContainerNetworkConnectionConfig{}.OpenAPIModelName(), v1.ContainerPemCertificates{}.OpenAPIModelName(), v1.ContainerPort{}.OpenAPIModelName(), v1.CreateFileSystem{}.OpenAPIModelName(), v1.HealthProbe{}.OpenAPIModelName(), v1.ImageLayer{}.OpenAPIModelName(), v1.TerminalSpec{}.OpenAPIModelName(), v1.VolumeMount{}.OpenAPIModelName(), commonapi.EnvVar{}.OpenAPIModelName(), metav1.MicroTime{}.OpenAPIModelName()},
	}
}
...
func schema_microsoft_dcp_api_v1_ContainerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"healthProbeResults": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Results of running health probes (most recent per probe)",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			v1.HealthProbeResult{}.OpenAPIModelName(), commonapi.EnvVar{}.OpenAPIModelName(), metav1.MicroTime{}.OpenAPIModelName()},
	}
}
...
func schema_microsoft_dcp_api_v1_ContainerVolume(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerVolume represents a volume that can be consumed by Container instances Its lifetime is independent from the lifetime of containers",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ContainerVolumeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerVolumeList contains a list of ContainerVolume instances",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"serviceNamespace", "serviceName", "address", "port"},
			},
		},
	}
}
...
func schema_microsoft_dcp_api_v1_Executable(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Executable resource represents an OS process, with one or more replicas",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ExecutableList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecutableList contains a list of Executable instances",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ExecutableReplicaSet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecutableReplicaSet resource represents a replication configuration for zero or more Executable resources",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ExecutableReplicaSetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecutableReplicaSetList contains a list of ExecutableReplicaSet instances",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v1_ExecutableReplicaSetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecutableReplicaSetSpec desribes the desired state of an ExecutableReplicaSet",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"replicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Number of desired child Executable objects",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
...
func schema_microsoft_dcp_api_v1_ExecutableReplicaSetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecutableReplicaSetStatus desribes the status of an ExecutableReplicaSet",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"observedReplicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Total number of observed child executables",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"runningReplicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Total number of current running child Executables",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"failedReplicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Total number of current Executable replicas that failed to start",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"finishedReplicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Total number of current child Executables that have finished running",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
...
func schema_microsoft_dcp_api_v1_ExecutableSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.AmbientEnvironment{}.OpenAPIModelName(), v1.ExecutablePemCertificates{}.OpenAPIModelName(), v1.HealthProbe{}.OpenAPIModelName(), v1.TerminalSpec{}.OpenAPIModelName(), commonapi.EnvVar{}.OpenAPIModelName(), metav1.MicroTime{}.OpenAPIModelName()},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"executionID": {
						SchemaProps: spec.SchemaProps{
							Description: "The execution ID is the identifier for the actual-state counterpart of the Executable. For ExecutionType == Process it is the process ID. Process IDs will be eventually reused by OS, but a combination of process ID and startup timestamp is unique for each Executable instance. For ExecutionType == IDE it is the IDE session ID.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"exitCode": {
						SchemaProps: spec.SchemaProps{
							Description: "Exit code of the process associated with the Executable. The value is equal to UnknownExitCode if the Executable was not started, is still running, or the exit code is not available.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"stdOutFile": {
						SchemaProps: spec.SchemaProps{
							Description: "The path of a temporary file that contains captured standard output data from the Executable process.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"stdErrFile": {
						SchemaProps: spec.SchemaProps{
							Description: "The path of a temporary file that contains captured standard error data from the Executable process.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_microsoft_dcp_api_v1_TunnelConfiguration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TunnelConfiguration defines a single tunnel enabled by a ContainerNetworkTunnelProxy.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "User-friendly name for the tunnel (used in status reporting and debugging). Must be unique within the ContainerNetworkTunnelProxy.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_microsoft_dcp_api_v1_TunnelStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TunnelStatus represents the status of a single tunnel within the proxy pair",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name of the tunnel (matches TunnelConfiguration.Name).",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"tunnelId": {
						SchemaProps: spec.SchemaProps{
							Description: "Internal tunnel ID assigned by the proxy pair.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"state": {
						SchemaProps: spec.SchemaProps{
							Description: "Current state of the tunnel.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"errorMessage": {
						SchemaProps: spec.SchemaProps{
							Description: "Human-readable explanation for why the tunnel preparation failed (if it did).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"target": {
						SchemaProps: spec.SchemaProps{
							Description: "The path within the container that the mount will use",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"readOnly": {
						SchemaProps: spec.SchemaProps{
							Description: "True if the mounted file system is supposed to be read-only",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
...
func schema_microsoft_dcp_api_v2_ContainerBuildContext(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerBuildContext describes how to build a container image from source.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"context": {
						SchemaProps: spec.SchemaProps{
					...
					"labels": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Labels to apply to the built image. When used by PhysicalContainerImage, DCP harvesting and physical resource UID labels are reserved and set by the controller.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_ContainerBuildSecret(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerBuildSecret is a secret made available to the image builder.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
					...
					"source": {
						SchemaProps: spec.SchemaProps{
							Description: "For file secrets, the source filepath of the secret; for env secrets, the environment variable name. Required for file secrets, optional for env secrets (defaults to the ID).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"value": {
						SchemaProps: spec.SchemaProps{
							Description: "Only used for env secrets. If set, this value is applied via the configured environment variable to the build command. If unset, the value comes from the ambient environment.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_microsoft_dcp_api_v2_ContainerNetworkConnectionConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerNetworkConnectionConfig describes a PhysicalContainerNetwork to attach to a container.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_ContainerPort(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ContainerPort describes a port, or contiguous range of ports, to publish from a container.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"hostPort": {
						SchemaProps: spec.SchemaProps{
					...
					"protocol": {
						SchemaProps: spec.SchemaProps{
							Description: "The protocol to be used, defaults to TCP.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_microsoft_dcp_api_v2_CreateFileSystem(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CreateFileSystem describes a set of files and directories to create inside a container.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"destination": {
						SchemaProps: spec.SchemaProps{
							Description: "The absolute path in the container that the entries are created relative to.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"defaultOwner": {
						SchemaProps: spec.SchemaProps{
							Description: "The default UID applied to entries that do not specify an owner.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"defaultGroup": {
						SchemaProps: spec.SchemaProps{
							Description: "The default GID applied to entries that do not specify a group.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"umask": {
						SchemaProps: spec.SchemaProps{
							Description: "The umask applied to entries that do not specify a mode.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
		...
		Dependencies: []string{
			v2.FileSystemEntry{}.OpenAPIModelName()},
	}
}

func schema_microsoft_dcp_api_v2_FileSystemEntry(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FileSystemEntry represents part of the file structure to be created in the container.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "The type of entry (file or directory).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"mode": {
						SchemaProps: spec.SchemaProps{
							Description: "The unix mode permissions of this entry. If Mode is 0, the umask for the create file request is applied.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"source": {
						SchemaProps: spec.SchemaProps{
							Description: "For file type entries, an optional path to a source file to copy. It is an error to set both Source and Contents for a file.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"continueOnError": {
						SchemaProps: spec.SchemaProps{
							Description: "For file type entries, if true, errors creating this file are logged but do not fail the operation.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"networks": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Networks describes PhysicalContainerNetworks to attach the container to. If omitted, the container runtime chooses the default network.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"labels": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Labels contains labels to apply to a newly-created runtime container. DCP harvesting and physical resource UID labels are reserved and set by the controller.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"pullRetryLimit": {
						SchemaProps: spec.SchemaProps{
							Description: "PullRetryLimit is how many times a failed source image pull is retried, with exponential backoff between attempts. Set to zero to fail on the first error. If omitted, a small default number of retries is used to absorb transient registry and network failures. Pulls are deferred while the container runtime is unhealthy, without consuming this limit.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_microsoft_dcp_api_v2_PhysicalContainerNetwork(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetwork represents one runtime container network in a DCP V2 namespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v2.PhysicalContainerNetworkSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v2.PhysicalContainerNetworkStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v2.PhysicalContainerNetworkSpec{}.OpenAPIModelName(), v2.PhysicalContainerNetworkStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"labels": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Labels contains labels to apply to a newly-created runtime network. DCP harvesting and physical resource UID labels are reserved and set by the controller.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_PhysicalContainerNetworkConnection(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetworkConnection represents desired runtime network membership for one physical container.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v2.PhysicalContainerNetworkConnectionSpec{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v2.PhysicalContainerNetworkConnectionSpec{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_microsoft_dcp_api_v2_PhysicalContainerNetworkConnectionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetworkConnectionList contains a list of PhysicalContainerNetworkConnection instances.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v2.PhysicalContainerNetworkConnection{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v2.PhysicalContainerNetworkConnection{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_microsoft_dcp_api_v2_PhysicalContainerNetworkConnectionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetworkConnectionSpec identifies the physical container and network that should be connected. Both references resolve within the connection resource's namespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"containerRef": {
						SchemaProps: spec.SchemaProps{
					...
					"aliases": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Aliases contains network-scoped aliases for the container.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
				...
				Required: []string{"containerRef", "networkRef"},
			},
		},
	}
}
...
func schema_microsoft_dcp_api_v2_PhysicalContainerNetworkList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetworkList contains a list of PhysicalContainerNetwork instances.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			v2.PhysicalContainerNetwork{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_microsoft_dcp_api_v2_PhysicalContainerNetworkSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetworkSpec describes either an existing runtime network or how to create one.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"networkID": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_PhysicalContainerNetworkStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerNetworkStatus describes the observed runtime network.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
					...
					"containerIDs": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "ContainerIDs are the runtime container IDs currently attached to the network.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_PhysicalContainerVolume(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerVolume represents one runtime container volume in a DCP V2 namespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v2.PhysicalContainerVolumeSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v2.PhysicalContainerVolumeStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v2.PhysicalContainerVolumeSpec{}.OpenAPIModelName(), v2.PhysicalContainerVolumeStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"labels": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Labels contains labels to apply to a newly-created runtime volume. DCP harvesting and physical resource UID labels are reserved and set by the controller.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_PhysicalContainerVolumeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerVolumeList contains a list of PhysicalContainerVolume instances.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			v2.PhysicalContainerVolume{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_microsoft_dcp_api_v2_PhysicalContainerVolumeSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerVolumeSpec describes either an existing runtime volume or how to create one.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"volumeID": {
						SchemaProps: spec.SchemaProps{
...
func schema_microsoft_dcp_api_v2_PhysicalContainerVolumeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PhysicalContainerVolumeStatus describes the observed runtime volume.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase summarizes whether the runtime volume is available.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"driver": {
						SchemaProps: spec.SchemaProps{
							Description: "Driver is the runtime volume driver.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"mountPoint": {
						SchemaProps: spec.SchemaProps{
							Description: "MountPoint is the host path where the runtime stores volume data, when exposed by the runtime.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"scope": {
						SchemaProps: spec.SchemaProps{
							Description: "Scope is the runtime volume scope.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_microsoft_dcp_api_v2_VolumeMount(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VolumeMount describes a file system to make available inside a container.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
