...
// Code generated by D:\usvc-apiserver\.toolbin\openapi-gen.exe. DO NOT EDIT.
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"url": {
						SchemaProps: spec.SchemaProps{
							Description: "The URL of the endpoint implementing the service",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_microsoft_usvc_apiserver_api_v1_Service(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Service represents a single service implemented by one or more endpoints Its lifetime is dependent on the lifetime of the Executables or Containers that it is attached to.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
