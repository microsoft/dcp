...
1. Open two PRs to merge the new `release` branch into `production`. Title the PRs `Merge release/<version> into production` and `Merge release/<version> into main` to make it easy to tell them apart.
