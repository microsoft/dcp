...
func (in *ContainerSpec) DeepCopyInto(out *ContainerSpec) {
	*out = *in
	...
	if in.VolumeMounts != nil {
		...
		*out = make([]commonapi.VolumeMount, len(*in))
		copy(*out, *in)
	}
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]commonapi.ContainerPort, len(*in))
		copy(*out, *in)
	}
	if in.Env != nil {
		in, out := &in.Env, &out.Env
	...
	if in.Networks != nil {
		...
		*out = new([]commonapi.ContainerNetworkConnectionConfig)
		if **in != nil {
			in, out := *in, *out
			*out = make([]commonapi.ContainerNetworkConnectionConfig, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
	...
	if in.CreateFiles != nil {
		...
		*out = make([]commonapi.CreateFileSystem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ImageLayers != nil {
		...
		*out = make([]commonapi.ImageLayer, len(*in))
		copy(*out, *in)
	}
